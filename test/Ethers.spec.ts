...
describe('Ethers', () => { 
    ...
    it('encode function', async () => { 
        ...
        const funcHash =  iface.encodeFunctionData("registerVIP", [ "0x1234567890123456789012345678901234567890", BigNumber.from("1") , "0x1234567890123456789012345678901234567890"])
